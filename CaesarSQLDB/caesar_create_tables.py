class CaesarCreateTables:
    def __init__(self) -> None:
        ...
        self.productownershipfields = ("productname","owner")
        self.productsfields = ("productname","price","description","filetype","thumbnail")
        self.productpurchaselogsfields = ("productname","owner","price")
    ...
    def create(self,caesarcrud):
        ...
        "users")
        caesarcrud.create_table("productownerid",self.productownershipfields,
        ("varchar(255) NOT NULL","varchar(255) NOT NULL"),
        "productownership")
        
        caesarcrud.create_table("productsid",self.productsfields,
        ("varchar(255) NOT NULL","INT NOT NULL","TEXT NOT NULL","varchar(255) NOT NULL","MEDIUMBLOB"),
        "products")

        caesarcrud.create_table("productpurchaselogsid",self.productpurchaselogsfields,
